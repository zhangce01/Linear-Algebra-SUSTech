...
\vspace{3pt}
Inspiration: Choose entries from each row and column, only consider the sun of those determinants, the others are all zero if we take 2 entries from a single row or column.
\end{frame}
