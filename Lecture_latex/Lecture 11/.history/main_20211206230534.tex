...
\vspace{3pt}
Consider eigenvalue $1$. How about find its geometric multiplicity first? $A-\lambda I=uu^T$, find its nullspace dimension (or you can also judge from the number of free columns). Then the algebraic multiplicity must be greater or equal than it.
\end{frame}
