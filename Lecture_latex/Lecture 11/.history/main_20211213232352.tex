...
\begin{example}
    ...
    (b) (2019 Fall, Final, 2 marks) Let $A$ be a real square matrix. Then a real number $\lambda$ is an eigenvalue of $A$ if and only if it is an eigenvalue of the transpose $A^T$.
\end{example}
\end{frame}
