...
\begin{equation*}
    ...
    \end{matrix} \right]
\end{equation*}
\textbf{Question 3:} Find the echelon form $U$, RREF matrix $R$, nullspace matrix $N$.

\vspace{3pt}
Do Gauss elimination and keep eliminating when failure occurs. Then we can get the echelon form.

\vspace{3pt}
For RREF form: 1.Eliminate entries on the top of pivots. 2. Make the pivots all 1.
