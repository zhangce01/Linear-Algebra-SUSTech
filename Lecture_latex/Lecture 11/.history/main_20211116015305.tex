...
At first, I don't want to show you complex computations. A question is: Determinant can show us what? Remind that every matrix can be recognized as a linear transformation.
\end{frame}
