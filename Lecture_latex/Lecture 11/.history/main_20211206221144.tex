...
The independent eigenvectors are not sufficient, so the matrix is not diagonlizable. (We say that the eigenvalue 2 is a liar, it claims that it has the multiplicity of 2 b)
