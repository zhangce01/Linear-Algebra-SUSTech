...
The core is: find the solution for $Ax=p$ where $p$ is the projection on $C(A)$, which can definitely gives a unique solution.

\begin{figure}
    \centering
    \includegraphics[width=0.62\textwidth]{ls.jpg}
\end{figure}
\begin{equation*}
