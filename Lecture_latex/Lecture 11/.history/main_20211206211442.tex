...
\vspace{5pt}
If a matrix is diagonlizable, we can easily find the diagonalization matrix! But the question is, we cannot tell if a matric has $n$ linearly independent eigenvectors.
\end{frame}
