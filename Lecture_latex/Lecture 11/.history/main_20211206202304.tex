...
\begin{enumerate}
    ...
    \item $A$ and $\Lambda $ is the same linear transformation using different basis.
    \item Diagonalization: change to eigenvaector basis, make linear transformation $A$ a simple stretching transformation $\Lambda$.
\end{enumerate}
\end{frame}
\section{}
