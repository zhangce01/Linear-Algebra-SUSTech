...
At first, I don't want to show you complex computations. A question is: determinant expresses what properties of matrix? Remind that every matrix can be recognized as a linear transformation.
