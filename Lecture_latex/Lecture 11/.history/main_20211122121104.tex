...
\end{equation*}
while $P$ is the permutation matrix that have determinant 1 or -1 (determined by the order of chosen entries). Another simplified expression: $P=\left( \alpha ,\beta ,\cdots ,\omega \right)$.
\end{frame}
