...
\end{frame}
%---------------------------------------------------------
\section{Issues about Peer Supporting Class}
...
\textbf{This Week:}
\begin{itemize}
    \item 2021.10.26 Chapter 2.6 by Zhang Ce
    \item 2021.10.28 Chapter 3.1-3.3 by Pan Shufan
    \item 2021.10.29 Chapter 3.1-3.3 by Chen Qiujiang
    \item 2021.10.30 Chapter 3.1-3.3 by Tang Xiangyi
\end{itemize}

\textbf{Next Week:}
\begin{itemize}
    \item 2021.11.2 Review Class by Zhang Ce
    \item 2021.11.4 Review Class by Pan Shufan
    \item 2021.11.5 Query Class by Chen Qiujiang(...)
    \item 2021.11.6 Midterm
\end{itemize}

Hope you all can get a satisfactory grade in the midterm exam!
\end{frame}

\begin{frame}{Midterm Review Materials}
We 4 tutors collect and write a midterm review note for you, it is in the QQ group files.
\begin{itemize}
    \item Chapter 1.1 - 1.6 by Zhang Ce
    \item Chapter 2.1 - 2.3 by Pan Shufan
    \item Chapter 2.4 - 2.6 by Tang Xiangyi
    \item Chapter 3.1 - 3.3 by Chen Qiujiang
\end{itemize}

\begin{figure}
    \includegraphics[width=0.9\textwidth]{Review.png}
\end{figure}
\end{frame}
