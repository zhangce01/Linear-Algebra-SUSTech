...
\begin{frame}{Jordan Form}
    ...
    While if a matrix has eigenvalues $\lambda$ with algebraic multiplicity of $n$ but geometric multiplicity of $n-1$, its simplest similar matrix $J$ will have a Jordan block like this.
\end{frame}
