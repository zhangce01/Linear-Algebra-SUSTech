...
To check if this relation of columns is still unchanged?
\begin{center}
...
Because nullspace never changes! The nullspace shows us which combination of columns can lead us to zero.
