...
If you can understand all of these, chapter 5 is simple combination of previous knowledge. Remember, always keep geometrical interpretation in head, instead of memorizing the formula (just like Gram-Schmidt process and vector spanning).
\end{frame}
\section{}
