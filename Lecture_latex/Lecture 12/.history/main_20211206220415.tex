...
\begin{equation*}
    \lambda _1=\lambda _2=2,\lambda _3=3
\end{equation*}
For the repeated eigenvalues, we need to check whether it has sufficient independent eigenvectors. Back to chapter 2, Find the nullspace dimension of $A-\lambda I$!
\end{frame}
