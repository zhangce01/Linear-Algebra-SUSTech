...
\begin{equation*}
    ...
    \end{array} \right] , \begin{cases}
        ...
        y_2=\frac{1}{\sqrt{5}}x_1+\frac{1}{\sqrt{5}}x_2\\
    \end{cases}
\end{equation*}

\begin{equation*}
    2{x_1}^2+4x_1x_2+5{x_2}^2=\left( \frac{2}{\sqrt{5}}x_1-\frac{1}{\sqrt{5}}x_2 \right) ^2+6\left( \frac{1}{\sqrt{5}}x_1+\frac{1}{\sqrt{5}}x_2 \right) ^2>0
\end{equation*}
