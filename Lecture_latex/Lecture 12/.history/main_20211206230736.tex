...
\vspace{3pt}
Matrix $A=I+uu^T$ has repeated eigenvalue $1$ with algebraic and geometric multiplicity of $n-1$, and eigenvalue $1+u^Tu$ with algebraic and geometric multiplicity of $1$.
\end{frame}
