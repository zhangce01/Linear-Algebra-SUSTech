...
\begin{enumerate}
    ...
    \item Your mission is to catch the liar. You investigate the possble liars: repeated eigenvalues. If you find that the eigenvalues don't have the same number of independent eigenvectors as it claimed, it is a liar. Once you catch 1 liar, the matrix is not diagonlizable any more.
\end{enumerate}
\end{frame}
